...
<head>
	<title>Tyrek | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('https://i.ibb.co/Fqr7DRv/fTyrek.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="https://i.ibb.co/fqzVDv7/mini-H-Tyrek.png" alt="Tyrek miniature" />
		</div>
		<div class="card switch">
			<img src="https://i.ibb.co/gd9rm6L/Tyrek.png" alt="Tyrek profile card" width="531" height="380" />
		</div>

...
<body>
	<div class="bioPage Hero" style="background:url('Img/fTyrek.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Tyrek.png" alt="Tyrek miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Tyrek.png" alt="Tyrek profile card" width="531" height="380" />
		</div>

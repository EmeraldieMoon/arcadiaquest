...
<head>
	<title>Kuruk | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fKuruk.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Kuruk.png" alt="Kuruk miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Kuruk.png" alt="Kuruk profile card" width="531" height="380" />
		</div>

...
<body>
	<div class="bioPage Hero" style="background:url('Img/fChooloo.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Chooloo.png" alt="Chooloo miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Chooloo.png" alt="Chooloo profile card" width="531" height="380" />
		</div>

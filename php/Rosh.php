...
<head>
	<title>Rosh | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fRosh.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Rosh.png" alt="Rosh miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Rosh.png" alt="Rosh profile card" width="531" height="380" />
		</div>

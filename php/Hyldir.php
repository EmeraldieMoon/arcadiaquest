...
<head>
	<title>Hyldir | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fHyldir.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Hyldir.png" alt="Hyldir miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Hyldir.png" alt="Hyldir profile card" width="531" height="380" />
		</div>

...
<body>
	<div class="bioPage Hero" style="background:url('Img/fAnnika.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Annika.png" alt="Annika miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Annika.png" alt="Annika profile card" width="531" height="380" />
		</div>

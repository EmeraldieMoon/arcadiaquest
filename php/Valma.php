...
<head>
	<title>Valma | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fValma.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Valma.png" alt="Valma miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Valma.png" alt="Valma profile card" width="531" height="380" />
		</div>

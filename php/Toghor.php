...
<head>
	<title>Toghor | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fToghor.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Toghor.png" alt="Toghor miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Toghor.png" alt="Toghor profile card" width="531" height="380" />
		</div>

...
<head>
	<title>Damian | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fDamian.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Damian.png" alt="Damian miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Damian.png" alt="Damian profile card" width="531" height="380" />
		</div>

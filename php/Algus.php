...
<head>
	<title>Algus | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fAlgus.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Algus.png" alt="Algus miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Algus.png" alt="Algus profile card" width="531" height="380" />
		</div>

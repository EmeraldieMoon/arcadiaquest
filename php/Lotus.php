...
<head>
	<title>Lotus | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fLotus.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Lotus.png" alt="Lotus miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Lotus.png" alt="Lotus profile card" width="531" height="380" />
		</div>

...
<head>
	<title>Phyx | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('https://i.ibb.co/S7RVxRP/fPhyx.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="https://i.ibb.co/G9PqLXC/mini-H-Phyx.png" alt="Phyx miniature" />
		</div>
		<div class="card switch">
			<img src="https://i.ibb.co/xgqtsvD/Phyx.png" alt="Phyx profile card" width="531" height="380" />
		</div>

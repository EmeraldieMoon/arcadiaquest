...
<head>
	<title>Brenna | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fBrenna.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Brenna.png" alt="Brenna miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Brenna.png" alt="Brenna profile card" width="531" height="380" />
		</div>

...
<head>
	<title>Leah | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fLeah.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Leah.png" alt="Leah miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Leah.png" alt="Leah profile card" width="531" height="380" />
		</div>

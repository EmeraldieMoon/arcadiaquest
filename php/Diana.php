...
<head>
	<title>Diana | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('https://i.ibb.co/hyYYSjC/fDiana.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="https://i.ibb.co/GMKJ61Y/mini-H-Diana.png" alt="Diana miniature" />
		</div>
		<div class="card switch">
			<img src="https://i.ibb.co/dQbwyDx/Diana.png alt="Diana profile card" width="531" height="380" />
		</div>

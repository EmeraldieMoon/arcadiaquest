...
<head>
	<title>Yona | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fYona.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Yona.png" alt="Yona miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Yona.png" alt="Yona profile card" width="531" height="380" />
		</div>

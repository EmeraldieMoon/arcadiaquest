...
<head>
	<title>Greybark | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fGreybark.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Greybark.png" alt="Greybark miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Greybark.png" alt="Greybark profile card" width="531" height="380" />
		</div>

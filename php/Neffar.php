...
<head>
	<title>Neffar | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fNeffar.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Neffar.png" alt="Neffar miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Neffar.png" alt="Neffar profile card" width="531" height="380" />
		</div>

...
<head>
	<title>Mamba | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fMamba.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Mamba.png" alt="Mamba miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Mamba.png" alt="Mamba profile card" width="531" height="380" />
		</div>

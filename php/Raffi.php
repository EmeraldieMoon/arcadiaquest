...
<head>
	<title>Raffi | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fRaffi.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Raffi.png" alt="Raffi miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Raffi.png" alt="Raffi profile card" width="531" height="380" />
		</div>

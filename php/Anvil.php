...
<head>
	<title>Anvil | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fAnvil.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Anvil.png" alt="Anvil miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Anvil.png" alt="Anvil profile card" width="531" height="380" />
		</div>

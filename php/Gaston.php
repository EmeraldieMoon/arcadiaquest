...
<head>
	<title>Gaston | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fGaston.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Gaston.png" alt="Gaston miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Gaston.png" alt="Gaston profile card" width="531" height="380" />
		</div>

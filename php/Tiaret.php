...
<head>
	<title>Tiaret | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fTiaret.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Tiaret.png" alt="Tiaret miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Tiaret.png" alt="Tiaret profile card" width="531" height="380" />
		</div>

...
<body>
	<div class="bioPage Hero" style="background:url('Img/fWisp.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Wisp.png" alt="Wisp miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Wisp.png" alt="Wisp profile card" width="531" height="380" />
		</div>

...
<body>
	<div class="bioPage Hero" style="background:url('Img/fSarya.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Sarya.png" alt="Sarya miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Sarya.png" alt="Sarya profile card" width="531" height="380" />
		</div>

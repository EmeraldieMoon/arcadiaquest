...
<head>
	<title>Sarya | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('https://i.ibb.co/ssqNh9v/fSarya.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="https://i.ibb.co/nwCQ8mJ/mini-H-Sarya.png" alt="Sarya miniature" />
		</div>
		<div class="card switch">
			<img src="https://i.ibb.co/TT2YcGg/Sarya.png" alt="Sarya profile card" width="531" height="380" />
		</div>

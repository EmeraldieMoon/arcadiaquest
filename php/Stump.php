...
<head>
	<title>Stump | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fStump.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Stump.png" alt="Stump miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Stump.png" alt="Stump profile card" width="531" height="380" />
		</div>

...
<head>
	<title>Jaimie | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('https://i.ibb.co/BcsZ6MG/fJaimie.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="https://i.ibb.co/4WX43mV/mini-H-Jaimie.png" alt="Jaimie miniature" />
		</div>
		<div class="card switch">
			<img src="https://i.ibb.co/6yhfpZB/Jaimie.png" alt="Jaimie profile card" width="531" height="380" />
		</div>

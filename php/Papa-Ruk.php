...
<head>
	<title>Papa Ruk | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('https://i.ibb.co/7zdCbyv/f-Papa-Ruk.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="https://i.ibb.co/1dLqD4Y/mini-H-Papa-Ruk.png" alt="Papa Ruk miniature" />
		</div>
		<div class="card switch">
			<img src="https://i.ibb.co/V2JtTzJ/Papa-Ruk.png" alt="Papa Ruk profile card" width="531" height="380" />
		</div>

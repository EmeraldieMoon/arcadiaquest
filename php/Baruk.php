...
<head>
	<title>Baruk | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fBaruk.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Baruk.png" alt="Baruk miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Baruk.png" alt="Baruk profile card" width="531" height="380" />
		</div>

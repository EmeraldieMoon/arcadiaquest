...
<head>
	<title>Bowie | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('https://i.ibb.co/hDY7DKC/fBowie.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="https://i.ibb.co/174h7Xm/mini-H-Bowie.png" alt="Bowie miniature" />
		</div>
		<div class="card switch">
			<img src="https://i.ibb.co/gDbYQvf/Bowie.jpg" alt="Bowie profile card" width="531" height="380" />
		</div>

...
<head>
	<title>Haldor | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fHaldor.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Haldor.png" alt="Haldor miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Haldor.png" alt="Haldor profile card" width="531" height="380" />
		</div>

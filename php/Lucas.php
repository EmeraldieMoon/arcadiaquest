...
<body>
	<div class="bioPage Hero" style="background:url('Img/fLucas.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Lucas.png" alt="Lucas miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Lucas.png" alt="Lucas profile card" width="531" height="380" />
		</div>

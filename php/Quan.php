...
<head>
	<title>Quan | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fQuan.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Quan.png" alt="Quan miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Quan.png" alt="Quan profile card" width="531" height="380" />
		</div>

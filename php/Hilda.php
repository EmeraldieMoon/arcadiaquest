...
<head>
	<title>Hilda | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fHilda.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Hilda.png" alt="Hilda miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Hilda.png" alt="Hilda profile card" width="531" height="380" />
		</div>

...
<head>
	<title>Mika | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fMika.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Mika.png" alt="Mika miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Mika.png" alt="Mika profile card" width="531" height="380" />
		</div>

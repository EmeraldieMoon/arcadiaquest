...
<head>
	<title>Makumba | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fMakumba.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Makumba.png" alt="Makumba miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Makumba.png" alt="Makumba profile card" width="531" height="380" />
		</div>

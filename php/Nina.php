...
<head>
	<title>Nina | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fNina.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Nina.png" alt="Nina miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Nina.png" alt="Nina profile card" width="531" height="380" />
		</div>

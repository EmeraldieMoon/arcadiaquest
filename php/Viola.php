...
<head>
	<title>Viola | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fViola.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Viola.png" alt="Viola miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Viola.png" alt="Viola profile card" width="531" height="380" />
		</div>

...
<head>
	<title>Travis | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fTravis.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Travis.png" alt="Travis miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Travis.png" alt="Travis profile card" width="531" height="380" />
		</div>

...
<head>
	<title>Aeric | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fAeric.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Aeric.png" alt="Aeric miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Aeric.png" alt="Aeric profile card" width="531" height="380" />
		</div>

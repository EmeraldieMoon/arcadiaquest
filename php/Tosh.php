...
<head>
	<title>Tosh | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fTosh.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Tosh.png" alt="Tosh miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Tosh.png" alt="Tosh profile card" width="531" height="380" />
		</div>

...
<head>
	<title>Azure | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fAzure.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Azure.png" alt="Azure miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Azure.png" alt="Azure profile card" width="531" height="380" />
		</div>

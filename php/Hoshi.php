...
<head>
	<title>Hoshi | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fHoshi.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Hoshi.png" alt="Hoshi miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Hoshi.png" alt="Hoshi profile card" width="531" height="380" />
		</div>

...
<head>
	<title>Luna | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fLuna.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Luna.png" alt="Luna miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Luna.png" alt="Luna profile card" width="531" height="380" />
		</div>

...
<head>
	<title>Crash | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fCrash.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Crash.png" alt="Crash miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Crash.png" alt="Crash profile card" width="531" height="380" />
		</div>

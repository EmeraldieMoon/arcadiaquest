...
<head>
	<title>Zsa Zsa | Arcadia Quest</title>
...
<body>
	<div class="bioPage Hero" style="background:url('Img/fZsa-Zsa.jpg') no-repeat scroll 0 0 #fff">
		...
		<div class="mini switch">
			<img src="Img/mini-H-Zsa-Zsa.png" alt="Zsa Zsa miniature" />
		</div>
		<div class="card switch">
			<img src="Img/card-H-Zsa-Zsa.png" alt="Zsa Zsa profile card" width="531" height="380" />
		</div>
